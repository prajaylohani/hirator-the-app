...
- [x] add references / hints: moved to readme todo
  - [x] [list of available colours: section 4.3 (svgnames) and 4.4 (x11names)](https://ftp.rrzn.uni-hannover.de/pub/mirror/tex-archive/macros/latex/contrib/xcolor/xcolor.pdf)
  - [x] add readme: move things from here
  - [x] draw excalidraw architecture in md here: mermaid
